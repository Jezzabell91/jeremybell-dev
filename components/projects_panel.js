...
const ProjectsPanel = () => {
   ...
   const [hr_trainer, cowgo, steggyhide, cityclimb] = projects
...
<div className="bg-white overflow-hidden">
  ...
  <div className="px-4 py-5 sm:p-6">
    {/* <!-- Content goes here --> */}
    {activeTab === 0 ? <ProjectDetails project={hr_trainer} /> : 
        activeTab === 1 ? <ProjectDetails project={cowgo} /> :
        activeTab === 2 ? <ProjectDetails project={steggyhide} /> : <ProjectDetails project={cityclimb} />}
  </div>
</div>
)
}
